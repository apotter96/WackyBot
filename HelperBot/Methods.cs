...
namespace HelperBot
{
    ...
    internal class Methods
    {
        ...
        public static void SendPM(Player player, string msg)
        {
            ...
            player.Message("{0}from {1}: {2}", Color.PM, Init.Instance.Name, msg);
        }
        ...
        public static void SendChat(string msg)
        {
            ...
            IRC.SendChannelMessage(Init.Instance.BotColor + Color.StripColors(Init.Instance.Name) + Color.Black + ": " + Color.StripColors(msg));
            Logger.Log(LogType.GlobalChat, (Init.Instance.BotColor + Color.StripColors(Init.Instance.Name) + Color.White + ": " + Color.StripColors(msg)));
            Server.Players.Message($"{Values.ClassyName}&F: {msg}");
        }
        ...
        public static void SendStaff(string msg)
        {
            ...
            msg = Color.ReplacePercentCodes(msg);
            Server.Players.Can(Permission.ReadStaffChat).Message(
                $"{Color.PM}(staff){Values.ClassyName}{Color.PM}: {msg}"
                );
        }
        ...
        public static bool ContainsBotName(String Message)
        {
            ...
            return Message.Contains(Init.Instance.Name.ToLower());
        }
