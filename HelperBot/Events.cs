    ...
    public static class Events
    {
        ...
        public static void ChatSentMessage(object sender, ChatSentEventArgs e)
        {
            ...
            if (Methods.DetectMessageImpersonation(e.Message) || Methods.IsPlayersDisplayedNameBots(e.Player))
            {
                ...
                {
                    if (Init.Instance.AnnounceImpersonation)
                    {
        ...
        public static void PlayerConnected(object sender, PlayerConnectedEventArgs e)
        {
            ...
            if (info.LeaveReason == LeaveReason.Kick && Init.Instance.AnnounceWarnKick)
            {
            ...
            else if (info.TimesVisited == 1 && Init.Instance.AnnounceGreeting)
            {
            ...
            else if (info.BlocksBuilt + info.BlocksDrawn < info.BlocksDeleted && Init.Instance.AnnounceSuggestBan)
            {
        ...
        {
            PlayerInfo info = e.Player.Info;
            if (info.TimeSinceLastKick < TimeSpan.FromDays(1) && info.TimesKicked > 0 && Init.Instance.AnnounceSuggestBan)
            {
